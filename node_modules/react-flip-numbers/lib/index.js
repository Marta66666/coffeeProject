...
var calculateDegrees = function calculateDegrees(rotateCounter, activeNumber) {
  ...
  return _objectSpread({}, activeNumber === 0 ? {
...
function (_React$Component) {
  ...
  function FlipNumber() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateNumber", function () {
  ...
  _createClass(FlipNumber, [{
    ...
    value: function render() {
      ...
      return React.createElement("span", {
        style: _objectSpread({}, viewPortSize, {
        ...
        tag: "span",
        play: play,
        start: _objectSpread({}, commonAnimateStyle),
        end: _objectSpread({}, commonAnimateStyle, {
